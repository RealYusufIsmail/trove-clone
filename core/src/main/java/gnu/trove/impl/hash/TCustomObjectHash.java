...
abstract public class TCustomObjectHash<T> extends TObjectHash<T> {
    ...
    /**
     * Creates a new <code>TManualObjectHash</code> instance with the default capacity and load
     * factor.
     */
    ...
    /**
     * Creates a new <code>TManualObjectHash</code> instance with a prime value at or near the
