...
public class TObjectPrimitiveHashMapTest extends TestCase {
    ...
    public void testConstructors() {
        ...
        TObjectIntHashMap<String> capacity = new TObjectIntHashMap<String>(20);
        for (int i = 0; i < element_count; i++) {
            capacity.put(keys[i], vals[i]);
        }
        assertEquals(map, capacity);

        TObjectIntHashMap<String> cap_and_factor = new TObjectIntHashMap<String>(20, 0.75f);
        for (int i = 0; i < element_count; i++) {
        ...
        TObjectIntHashMap<String> copy = new TObjectIntHashMap<String>(fully_specified);
    ...
    public void testIterator() {
        ...
        assertTrue("invalid key: " + first_key, first_key.equals("one") || first_key.equals("two"));
