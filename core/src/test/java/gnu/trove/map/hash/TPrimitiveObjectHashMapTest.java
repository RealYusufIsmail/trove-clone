...
public class TPrimitiveObjectHashMapTest extends TestCase {
    ...
    public void testConstructors() {
        ...
        TIntObjectMap<String> capacity = new TIntObjectHashMap<String>(20);
        for (int i = 0; i < element_count; i++) {
            capacity.put(keys[i], vals[i]);
        }
        assertEquals(map, capacity);

        TIntObjectMap<String> cap_and_factor = new TIntObjectHashMap<String>(20, 0.75f);
        for (int i = 0; i < element_count; i++) {
        ...
        TIntObjectMap<String> copy = new TIntObjectHashMap<String>(map);
    ...
    public void testKeySetContainsAllArray() {
        ...
        assertFalse(
                "should not contain all. keyset: " + keyset + ", " + Arrays.toString(other_array),
    ...
    public void testKeySetRetainAllTCollection() {
        ...
        assertFalse("keyset: " + keyset + ", should be unmodified.", keyset.retainAll(keyset));

        TIntCollection other = new TIntArrayList(keyset);
        assertFalse("keyset: " + keyset + ", should be unmodified. other: " + other,
                keyset.retainAll(other));

        other.remove(keys[5]);
        assertTrue("keyset: " + keyset + ", should be modified. other: " + other,
                keyset.retainAll(other));
        assertFalse(keyset.contains(keys[5]));
        assertFalse(map.containsKey(keys[5]));
        assertFalse(map.containsValue(vals[5]));
        assertTrue("keyset: " + keyset + ", should contain all in other: " + other,
                keyset.containsAll(other));
    }
    ...
    public void testKeySetRetainAllArray() {
        ...
        assertFalse("keyset: " + keyset + ", should be unmodified. array: " + Arrays.toString(keys),
        ...
        assertTrue("keyset: " + keyset + ", should be modified. array: " + Arrays.toString(other),
                keyset.retainAll(other));
    }
    ...
    public void testKeySetRemoveAllCollection() {
        ...
        assertFalse("collection: " + keyset + ", should contain all in list: " + java_list,
                keyset.removeAll(java_list));

        java_list.add(keys[5]);
        assertTrue("collection: " + keyset + ", should contain all in list: " + java_list,
                keyset.removeAll(java_list));
        assertFalse(keyset.contains(keys[5]));
        assertFalse(map.containsKey(keys[5]));
        assertFalse(map.containsValue(vals[5]));
    ...
    public void testKeySetRemoveAllTCollection() {
        ...
        assertFalse("collection: " + keyset + ", should be unmodified.", keyset.removeAll(other));

        other = new TIntArrayList(keyset);
        other.remove(keys[5]);
        assertTrue("collection: " + keyset + ", should be modified. other: " + other,
        ...
        assertFalse("collection: " + keyset + ", should be unmodified. other: " + other,
                keyset.removeAll(other));
    ...
    public void testKeySetRemoveAllArray() {
        ...
        int[] other = {1138};
        assertFalse(
                "collection: " + keyset + ", should be unmodified. array: " + Arrays.toString(vals),
                keyset.removeAll(other));
        ...
        assertTrue(
                "collection: " + keyset + ", should be modified. array: " + Arrays.toString(other),
                keyset.removeAll(other));
        assertEquals(1, keyset.size());
        for (int i = 0; i < element_count; i++) {
            if (i == 5) {
    ...
    public void testKeySetEqual() {
        ...
        assertTrue("sets incorrectly not equal: " + keyset + ", " + other, keyset.equals(other));

        int[] mismatched = {72, 49, 53, 1024, 999};
        TIntSet unequal = new TIntHashSet();
        unequal.addAll(mismatched);

        assertFalse("sets incorrectly equal: " + keyset + ", " + unequal, keyset.equals(unequal));
    ...
    public void testHashCode() {
        ...
        assertFalse(
                "hashcodes are unlikely equal.  map2: " + map2 + " (" + map2.hashCode()
                        + ")\nmap3: " + map3 + " (" + map3.hashCode() + ")",
    ...
    public void testFloatZeroHashing() {
        ...
        final String zero_bits_double = Long.toBinaryString(Double.doubleToLongBits(zero_double));
        ...
        final String zero_bits_float = Integer.toBinaryString(Float.floatToIntBits(zero_float));
