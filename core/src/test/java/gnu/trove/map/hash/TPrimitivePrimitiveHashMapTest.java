...
public class TPrimitivePrimitiveHashMapTest {
    ...
    public void testKeySetRetainAllTCollection() {
        ...
        // test with a TCollection
        TIntSet tintset = new TIntHashSet(keys);
        assertFalse("set: " + set + ", collection: " + tintset, set.retainAll(tintset));
        TIntCollection collection = new TIntArrayList(keys);
        assertFalse("set: " + set + ", collection: " + collection, set.retainAll(collection));

        collection.remove(42);
        assertTrue("set: " + set + ", collection: " + collection, set.retainAll(collection));
        assertEquals(keys.length - 1, set.size());
        assertEquals(keys.length - 1, map.size());
    }
    ...
    public void testKeySetRetainAllArray() {
        ...
        assertEquals("removed: " + keys[3] + ", set: " + set, keys.length - 1, set.size());
    ...
    public void testKeySetRemoveAllTCollection() {
        ...
        assertFalse("set: " + set + ", collection: " + tintset, set.removeAll(tintset));

        // With partial set
        tintset = new TIntHashSet(keys);
        tintset.remove(42);
        assertTrue("set: " + set + ", collection: " + tintset, set.removeAll(tintset));
        assertEquals("set: " + set, 1, set.size());
        assertEquals("set: " + set, 1, map.size());
        for (int i = 0; i < keys.length; i++) {
            if (keys[i] == 42) {
        ...
        assertFalse("set: " + set + ", collection: " + collection, set.removeAll(collection));

        // partial list
        collection = new TIntArrayList(keys);
        collection.remove(42);
        assertTrue("set: " + set + ", collection: " + collection, set.removeAll(collection));
        assertEquals("set: " + set, 1, set.size());
        assertEquals("set: " + set, 1, map.size());
        for (int i = 0; i < keys.length; i++) {
            if (keys[i] == 42) {
    ...
    public void testKeySetRemoveAllArray() {
        ...
        assertEquals("removed: " + keys[3] + ", set: " + set, 1, set.size());
        assertEquals("removed: " + keys[3] + ", set: " + set + "\nmap: " + map, set.size(),
                map.size());
    }
    ...
    public void testValueCollectionMisc() {
        ...
        assertFalse("remove of element not in collection succeded: " + values, values.remove(1));
        assertEquals(keys.length, values.size());
        assertEquals(keys.length, map.size());

        assertTrue("remove of element in collection failed: " + values, values.remove(42 * 2));
    ...
    public void testValueCollectionRetainAllTCollection() {
        ...
        // test with a TCollection
        TLongSet tintset = new TLongHashSet(vals);
        assertFalse("values: " + values + ", collection: " + tintset, values.retainAll(tintset));
    ...
    public void testValueCollectionRetainAllArray() {
        ...
        assertEquals("removed: " + keys[3] + ", values: " + values, keys.length - 1, values.size());
    ...
    public void testValueCollectionRemoveAllTCollection() {
        ...
        assertFalse("values: " + values + ", collection: " + tlongset, values.removeAll(tlongset));

        // With partial set
        tlongset = new TLongHashSet(vals);
        tlongset.remove(42 * 2);
        assertTrue("values: " + values + ", collection: " + tlongset, values.removeAll(tlongset));
        assertEquals("set: " + values, 1, values.size());
        assertEquals("set: " + values, 1, map.size());
        for (int i = 0; i < keys.length; i++) {
            if (keys[i] == 42) {
    ...
    public void testValueCollectionRemove() {
        ...
        assertEquals("Value collection has not been shrinked by iterator.remove().", initSize - 1,
                values.size());
        assertEquals("Corresponding map has not been shrinked by iterator.remove().", initSize - 1,
                map.size());
    }
    ...
    public void testValueCollectionRemoveAllArray() {
        ...
        assertEquals("removed: " + keys[3] + ", values: " + values, 1, values.size());
    ...
    public void testValueCollectionEquals() {
        ...
        assertFalse("values incorrectly equals a random object", values_list.equals(new Object()));
    ...
    public void testValueCollectionHashCode() {
        ...
        assertEquals(map.size(), values.size());
        assertFalse(values.isEmpty());
        assertEquals("hashcodes incorrectly not equal: " + map + ", " + values, values.hashCode(),
                values.hashCode());
    ...
    public void testValues() {
        ...
        for (int i = 0; i < element_count; i++) {
            assertEquals("expected: " + i * i + " got: " + vals[i] + ", i: " + i + ", vals: "
                    + Arrays.toString(vals), i * i, vals[i]);
