...
public class THashSetTest extends TestCase {
    ...
    public void testContainsAll() throws Exception {
        ...
        assertTrue("containsAll failed: " + s, s.containsAll(Arrays.asList(o)));

        String[] more = {"Hello World", "Goodbye World", "Hello Goodbye", "Not There"};
        assertFalse("containsAll failed: " + s, s.containsAll(Arrays.asList(more)));
    }
    ...
    public void testRetainAll() throws Exception {
        ...
        assertTrue("retainAll failed: " + set, set.retainAll(Arrays.asList(retain)));
        assertTrue("containsAll failed: " + set, set.containsAll(Arrays.asList(retain)));
    }
    ...
    public void testRemoveAll() throws Exception {
        ...
        assertTrue("removeAll failed: " + set, set.removeAll(Arrays.asList(remove)));
        assertTrue("removeAll failed: " + set, set.containsAll(Arrays.asList("Keep Me")));
    ...
    /**
     * this tests that we throw when people violate the general contract for hashcode on
     * java.lang.Object
     */
    @SuppressWarnings({"MismatchedQueryAndUpdateOfCollection"})
    ...
    public void testEqualsNonSet() {
        ...
        assertFalse("sets incorrectly equals map: " + set + ", " + map, set.equals(map));
    }
    ...
    public void testCompact() {
        ...
        assertFalse(max_length + " should != " + compacted_length, max_length == compacted_length);
    }
