...
public class TLinkedListTest {
    ...
    public void testContains() {
        ...
        assertTrue("list contains item: " + item + ", " + list, list.contains(item));

        item = new Data(1138);
        assertFalse("list doesn't contain item: " + item + ", " + list, list.contains(item));
    }
    ...
    public void testRemoveInvalidObject() {
        ...
        assertFalse("cannot remove elements that don't implement TLinkable", list.remove(obj));
    }
